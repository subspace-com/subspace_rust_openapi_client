...
/// struct for typed errors of method `accelerator_service_create`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AcceleratorServiceCreateError {
...
/// struct for typed errors of method `accelerator_service_delete`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AcceleratorServiceDeleteError {
    Status400(serde_json::Value),
    Status401(serde_json::Value),
    Status402(serde_json::Value),
    Status403(serde_json::Value),
...
/// struct for typed errors of method `accelerator_service_get`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AcceleratorServiceGetError {
    Status400(serde_json::Value),
    Status401(serde_json::Value),
    Status402(serde_json::Value),
    Status403(serde_json::Value),
...
/// struct for typed errors of method `accelerator_service_list`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AcceleratorServiceListError {
    Status400(serde_json::Value),
    Status401(serde_json::Value),
    Status402(serde_json::Value),
    Status403(serde_json::Value),
...
/// struct for typed errors of method `accelerator_service_update`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum AcceleratorServiceUpdateError {
    Status400(serde_json::Value),
    Status401(serde_json::Value),
    Status402(serde_json::Value),
    Status403(serde_json::Value),
...
pub async fn accelerator_service_create(configuration: &configuration::Configuration, body: crate::models::Body, idempotency_key: Option<&str>) -> Result<crate::models::V1Accelerator, Error<AcceleratorServiceCreateError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v1/accelerators", configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcceleratorServiceCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn accelerator_service_delete(configuration: &configuration::Configuration, id: &str) -> Result<serde_json::Value, Error<AcceleratorServiceDeleteError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/v1/accelerators/{id}", configuration.base_path, id=crate::apis::urlencode(id));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcceleratorServiceDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn accelerator_service_get(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::V1Accelerator, Error<AcceleratorServiceGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcceleratorServiceGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn accelerator_service_list(configuration: &configuration::Configuration, before: Option<&str>, limit: Option<i64>) -> Result<crate::models::V1ListAcceleratorsResponse, Error<AcceleratorServiceListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcceleratorServiceListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn accelerator_service_update(configuration: &configuration::Configuration, id: &str, body1: crate::models::Body1, if_match: Option<i32>) -> Result<crate::models::V1Accelerator, Error<AcceleratorServiceUpdateError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&body1);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcceleratorServiceUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
