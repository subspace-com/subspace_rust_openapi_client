...
pub struct V1Accelerator {
    ...
    #[serde(rename = "subspaceIp", skip_serializing_if = "Option::is_none")]
    pub subspace_ip: Option<String>,
    #[serde(rename = "subspaceIpv4", skip_serializing_if = "Option::is_none")]
    pub subspace_ipv4: Option<String>,
    #[serde(rename = "subspacePort", skip_serializing_if = "Option::is_none")]
