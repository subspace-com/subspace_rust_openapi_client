...
pub struct V1Accelerator {
    ...
    pub protocol: Option<crate::models::V1Protocol>,
    #[serde(rename = "subspace_ip", skip_serializing_if = "Option::is_none")]
    pub subspace_ip: Option<String>,
    #[serde(rename = "subspace_ipv4", skip_serializing_if = "Option::is_none")]
    pub subspace_ipv4: Option<String>,
    #[serde(rename = "subspace_port", skip_serializing_if = "Option::is_none")]
    pub subspace_port: Option<i64>,
}

impl V1Accelerator {
    pub fn new() -> V1Accelerator {
        V1Accelerator {
            destination_ip: None,
