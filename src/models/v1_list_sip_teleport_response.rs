...
pub struct V1ListSipTeleportResponse {
    #[serde(rename = "nextPage", skip_serializing_if = "Option::is_none")]
    pub next_page: Option<Box<crate::models::V1NextPage>>,
    #[serde(rename = "sipTeleports", skip_serializing_if = "Option::is_none")]
    pub sip_teleports: Option<Vec<crate::models::V1SipTeleportResponse>>,
}

impl V1ListSipTeleportResponse {
    pub fn new() -> V1ListSipTeleportResponse {
