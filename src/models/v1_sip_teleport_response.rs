...
pub struct V1SipTeleportResponse {
    ...
    #[serde(rename = "teleport_entry_points", skip_serializing_if = "Option::is_none")]
    pub teleport_entry_points: Option<Vec<crate::models::V1TeleportAddresses>>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::V1SipTeleportStatus>,
...
impl V1SipTeleportResponse {
    pub fn new() -> V1SipTeleportResponse {
        V1SipTeleportResponse {
            id: None,
            name: None,
            destination: None,
            teleport_entry_points: None,
            status: None,
            date_created: None,
            date_updated: None,
        }
