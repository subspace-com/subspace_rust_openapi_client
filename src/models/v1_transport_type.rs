...
pub enum V1TransportType {
    #[serde(rename = "UDP_TCP")]
    UDPTCP,
    #[serde(rename = "TLS")]
    TLS,
...
impl ToString for V1TransportType {
    fn to_string(&self) -> String {
        match self {
            Self::UDPTCP => String::from("UDP_TCP"),
            Self::TLS => String::from("TLS"),
        }
    }
}

impl Default for V1TransportType {
    fn default() -> V1TransportType {
        Self::UDPTCP
    }
}
