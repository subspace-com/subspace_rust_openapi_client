...
pub struct V1UpdateSipTeleport {
    /// Name of SIPTeleport
    #[serde(rename = "name")]
    pub name: String,
    ...
    #[serde(rename = "status")]
    pub status: crate::models::V1SipTeleportStatus,
}

impl V1UpdateSipTeleport {
    pub fn new(name: String, destination: String, status: crate::models::V1SipTeleportStatus) -> V1UpdateSipTeleport {
        V1UpdateSipTeleport {
            name,
            destination,
            status,
